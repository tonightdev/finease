...
export default function AdminReportsPage() {
  ...
  const engagementData = [
    ...
    { name: 'Inactive', value: Math.max(0, (stats?.totalUsers || 0) - (stats?.activeUsers24h || 0)) }
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <Card className="lg:col-span-2 p-4 space-y-4 rounded-2xl">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-widest">Growth Trends</h3>
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">User registrations over the last period</p>
            </div>
        ...
        <Card className="p-4 space-y-5 rounded-2xl">
           <div>
              <h3 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-widest text-center">Service Health</h3>
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest text-center">Real-time infrastructure status</p>
           </div>
           ...
           <div className="flex flex-col items-center justify-center space-y-6 py-4">
              ...
              <div className="w-full space-y-4">
                 {[
                   ...
                   { label: 'Security', value: 'Verified', color: 'bg-indigo-500' },
        ...
        <Card className="p-4 space-y-4 rounded-2xl flex flex-col justify-center">
           <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-widest">Engagement</h3>
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Active vs Total nodes</p>
              </div>
           ...
           <div className="grid grid-cols-2 gap-3">
              <div className="bg-slate-50 dark:bg-white/5 p-3 rounded-2xl border border-slate-100 dark:border-white/5">
                 ...
                 <p className="text-sm font-black text-slate-900 dark:text-white">{stats?.activeUsers24h}</p>
              </div>
              <div className="bg-slate-50 dark:bg-white/5 p-3 rounded-2xl border border-slate-100 dark:border-white/5">
                 <div className="flex items-center gap-2 mb-1">
                 ...
                 <p className="text-sm font-black text-slate-900 dark:text-white">{stats?.totalUsers}</p>
              </div>
           </div>
        </Card>
        ...
        <Card className="lg:col-span-2 p-4 space-y-5 rounded-2xl">
           <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-widest">Platform Events</h3>
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Latest system and security activities</p>
              </div>
           ...
           <div className="space-y-4">
              {stats?.recentActivities && stats.recentActivities.length > 0 ? (
                stats.recentActivities.map((log) => (
                  <div key={log.id} className="flex items-center justify-between p-3.5 bg-slate-50/50 dark:bg-white/[0.02] rounded-2xl border border-slate-100 dark:border-white/5">
                     <div className="flex items-center gap-4">
                        ...
                        <div>
                           ...
                           <p className="text-[9px] font-bold text-slate-400 uppercase">{log.type.replace(/_/g, ' ')}</p>
                        </div>
                     </div>
