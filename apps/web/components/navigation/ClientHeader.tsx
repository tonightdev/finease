...
export function ClientHeader() {
  ...
  return (
    <header className="sticky top-0 w-full z-50 border-b border-slate-200/50 dark:border-white/5 bg-white/70 dark:bg-black/40 backdrop-blur-xl pt-[env(safe-area-inset-top)]">
