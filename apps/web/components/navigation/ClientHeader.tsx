        ...
        <div className="flex items-center gap-4">
          ...
          {!loading && !user && (
            <div className="flex items-center gap-4">
              ...
              <Link href="/signup" className="px-5 py-2.5 bg-slate-900 dark:bg-white text-white dark:text-slate-900 text-[10px] font-black uppercase tracking-widest rounded-xl hover:scale-105 transition-all active:scale-95 shadow-xl shadow-slate-200 dark:shadow-none">
                Get Started
              </Link>
            </div>
          )}
