...
export function PageHeader({
  ...
  return (
    <div
      className={`sticky top-16 z-40 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 pt-1.5 pb-1.5 border-b border-slate-200 dark:border-white/5 mb-3 ${className}`}
    >
